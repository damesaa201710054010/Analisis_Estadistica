...
```{r}
plot(frecuenciasCulture, type="cfh")   #histograma de frecuencias acumulada
```

Poligono de frecuencias

```{r}
plot(frecuenciasCulture, type="cfp") 
```
...
histograma de frecuencias acumulada
```{r}
plot(frecuenciasEdades, type="cfh")   #histograma de frecuencias acumulada
```

Poligono de frecuencias

```{r}
plot(frecuenciasEdades, type="cfp") 
```
...
histograma de frecuencias acumulada
```{r}
plot(frecuenciasAnuales, type="cfh")   #histograma de frecuencias acumulada
```

Poligono de frecuencias

```{r}
plot(frecuenciasAnuales, type="cfp") 
```
...
histograma de frecuencias acumulada
```{r}
plot(frecuenciasTeatro, type="cfh")   #histograma de frecuencias acumulada
```

Poligono de frecuencias

```{r}
plot(frecuenciasTeatro, type="cfp") 
```
...
histograma de frecuencias acumulada
```{r}
plot(frecuenciasTeatroly, type="cfh")   #histograma de frecuencias acumulada
```

Poligono de frecuencias

```{r}
plot(frecuenciasTeatroly, type="cfp") 
```
